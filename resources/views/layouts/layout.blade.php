...
<head>
  ...
  <title>@yield('title', 'Kelly Bootstrap Template')</title>
    ...
    <div class="container-fluid position-relative d-flex align-items-center justify-content-between">
      ...
      <nav id="navmenu" class="navmenu">
        <ul>
          ...
          <li><a href="{{ route('blog') }}" class="{{ Request::is('services') ? 'active' : '' }}">Blog</a></li>
          <li><a href="{{ route('portfolio') }}" class="{{ Request::is('portfolio') ? 'active' : '' }}">Projects</a></li>
